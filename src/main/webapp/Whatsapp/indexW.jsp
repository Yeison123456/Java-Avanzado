...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/Assests/css/Whatsapp/IndexW.css">
    <title>Index</title>
...
<body>
     <header>
        <div class="menu">
            ...
            <nav>
                ...
                <a href="servlets?accion=login" class="inicio">Iniciar sesión</a>
            </nav>
        </div>
     </header>
     ...
     <main class="contenido">
        <div id="contenido1">
            <div class="img1">
                <img src="resources/Assests/img/img.png" alt="">
            </div>
