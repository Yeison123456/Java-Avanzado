...
<head>
    ...
    <link rel="stylesheet" href="resources/Assests/css/Instagram/UsuarioC.css">
    ...
    <main>
        <div class="formulario">
            <form action="">
                ...
                <a href="servlets?accion=usuarioCI" class="crear"type="submit" >Crear</a>

            </form>
        </div>
        <h1>Crear <b style="color: #bc4e9c;">usuario</b> nuevo</h1>
    </main>
