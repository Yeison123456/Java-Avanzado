...
<head>
    ...
    <link rel="stylesheet" href="resources/Assests/css/Instagram/ComentarioM.css">
    ...
    <main>
        <div class="formulario">
            <form action="">
                ...
                <a href="servlets?accion=comentarioMI" class="crear"type="submit" >Modificar</a>

            </form>
        </div>
        <h1><b style="color: #bc4e9c;">Modificar</b> Comentario</h1>
