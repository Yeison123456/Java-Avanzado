...
<head>
    ...
    <link rel="stylesheet" href="resources/Assests/css/Instagram/Historia.css">
    ...
    <main>
        <div class="formulario">
            <form action="">
                ...
                <a href="servlets?accion=historiaCI" class="crear"type="submit" >Crear</a>

            </form>
        </div>
        <img src="resources/Assests/img/17.png" alt="">
        <h1>Crear <b style="color: #bc4e9c;">Historia</b></h1>
    </main>
