...
<head>
    ...
    <link rel="stylesheet" href="resources/Assests/css/Instagram/ComentarioCI.css">
...
<body>
    ...
    <main>
        <div class="formulario">
            <form action="">
                <input type="text" placeholder="Seleccione imagen o video" id="username" name="username">
                ...
                <a href="servlets?accion=comentarioCI" class="crear"type="submit" >Crear</a>

            </form>
        </div>
        <h1><b style="color: #bc4e9c;">Crear</b> Comentario</b></h1>
