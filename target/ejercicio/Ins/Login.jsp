...
<html>
  <head>
    ...
    <link rel="stylesheet" href="resources/Assests/css/Instagram/loginI.css">
  </head>
  <body class="logon1">
    <div class="login">
      ...
      <form action="servlets" method="post">
        ...
        <a href="servlets?accion=indexI" class="atras"type="submit" >Atras</a>
        <button class="entrar" type="submit" name="accion" value="entrarI">Entrar</button><br><br><br>
      </form>
    </div>
